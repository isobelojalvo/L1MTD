...
##the analyzer
process.L1MTDAnalyzer = cms.EDAnalyzer('mtdIsoAnalyzer',
                                       timingValuesNominal = cms.InputTag("ttTrackTimeValueMapProducer","TTTracksFromTrackletL1ConfigurableFlatResolutionModel"),
                                       ...
                                       l1PFMETTime      = cms.InputTag("L1TrackerEtMisstime","MET_time","L1"),
                                       recoElectrons    = cms.InputTag("slimmedElectrons", "", "RECO"),
                                       recoMuons        = cms.InputTag("slimmedMuons", "", "RECO"),
                                       recoTaus         = cms.InputTag("slimmedTaus", "", "RECO"),
                                       recoMet          = cms.InputTag("slimmedMETs","","RECO"),
...
process.schedule = cms.Schedule(process.EcalEBtp_step,process.L1TrackTrigger_step,process.L1simulation_step,process.timingtracks,process.l1pf,process.L1PFTaus,process.mettime,process.analyzer,process.endjob_step) 
